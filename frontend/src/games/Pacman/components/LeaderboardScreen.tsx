  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-3xl mx-auto space-y-8 animate-fade-in p-6">
      ...
      <button
        onClick={onRestart}
        disabled
        className="mt-10 bg-yellow-500 hover:bg-yellow-400 text-black font-bold py-6 px-12 rounded-lg pixel-font text-xl md:text-2xl transition-transform active:scale-95 shadow-[0_0_15px_rgba(234,179,8,0.6)] opacity-50 cursor-not-allowed pointer-events-none"
      >
        PLAY AGAIN
      </button>
    </div>
